...
class Log(BotCommand):
    def actions(self):
        return super(Log, self).actions() + [('message-channel', -1, self.input),
                                             ('message-user', -1, self.input),
                                             ('action-channel', -1, self.input),
                                             ('action-user', -1, self.input),
                                             ('notice-channel', -1, self.input),
                                             ('notice-user', -1, self.input),
                                             ('channeljoin', -1, self.input),
                                             ('channelinvite', -1, self.input),
                                             ('channelpart', -1, self.input),
                                             ('channelkick', -1, self.input),
                                             ('userquit', -1, self.input),
                                             ('usernick', -1, self.input),
                                             ('modeschanged-channel', -1, self.input),
                                             ('modeschanged-user', -1, self.input),
                                             ('channeltopic', -1, self.input),
